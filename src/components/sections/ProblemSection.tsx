          ...
          >
            {orbitItems.map((item) => (
              ...
              >
                <div
                  data-orbit-card
                  className="w-space-32 shrink-0 rounded-lg border border-hairline bg-surface px-space-3 py-space-3 text-center shadow-card lg:w-space-40 lg:px-space-5 lg:py-space-5"
                >
