...
const DURATION_ACCENT =
    DURATION_SECONDARY * PHI_INVERSE;

const DURATION_MICRO =
    DURATION_ACCENT * PHI_INVERSE;
...
const services: Service[] = [
    {
        ...
        imageAlt:
            "Peças de xadrez sobre um tabuleiro.",
        items: [
            {
                icon: "clipboard",
                label:
    ...
    },
    {
        ...
        imageAlt:
            "Notebook aberto em uma mesa de trabalho.",
        items: [
            {
                icon: "palette",
                label:
                ...
                <div className="flex min-w-0 flex-col justify-center gap-space-6 p-space-6 md:col-span-3 md:p-space-10">
                    ...
                    >
                        <div className="w-fit rounded-md bg-badge px-space-3 py-space-1">
                            <p className="text-label uppercase text-ink">
                                {
                                    service.tag
                                }
                            </p>
